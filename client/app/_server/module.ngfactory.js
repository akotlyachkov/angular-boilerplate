...
import * as i22 from '../providers/data';
import * as i23 from '../layouts/master1/master1';
import * as i24 from '../pages/index/index';
import * as i25 from '../pages/page1/page1';
import * as i26 from '../layouts/master2/master2';
import * as i27 from '../pages/page2/page2';
import * as i28 from '../controls/control3/control3';
import * as i29 from '../controls/control4/control4';
import * as i30 from '../controls/module';
import * as i31 from '../pages/module';
import * as i32 from '../routes';
import * as i33 from '../module';
export var ServerAppModuleNgFactory = i0.ɵcmf(i1.ServerAppModule, [i2.DefaultLayout], function (_l) {
    return i0.ɵmod([i0.ɵmpd(512, i0.ComponentFactoryResolver, i0.ɵCodegenComponentFactoryResolver, [[8, [i3.Master1LayoutNgFactory, i4.IndexPageNgFactory, i5.Page1PageNgFactory,
        ...
        i0.ɵmpd(4608, i18.AnimationBuilder, i15.ɵBrowserAnimationBuilder, [i0.RendererFactory2,
            i12.DOCUMENT]), i0.ɵmpd(4608, i19.ɵi, i19.ɵi, []), i0.ɵmpd(5120, i20.ActivatedRoute, i20.ɵf, [i20.Router]), i0.ɵmpd(4608, i20.NoPreloading, i20.NoPreloading, []), i0.ɵmpd(6144, i20.PreloadingStrategy, null, [i20.NoPreloading]), i0.ɵmpd(135680, i20.RouterPreloader, i20.RouterPreloader, [i20.Router, i0.NgModuleFactoryLoader, i0.Compiler,
            ...
            return [p0_0];
        }, [i20.ROUTER_INITIALIZER]), i0.ɵmpd(4608, i21.CommunicateService, i21.CommunicateService, []), i0.ɵmpd(4608, i22.DataProvider, i22.DataProvider, [i17.HttpClient]),
        ...
        i0.ɵmpd(1024, i20.ROUTES, function () {
            return [[{ path: '', component: i23.Master1Layout, children: [{ path: '', component: i24.IndexPage },
                            { path: 'page1', component: i25.Page1Page }] }, { path: 'page2', component: i26.Master2Layout,
                        children: [{ path: '', component: i27.Page2Page, children: [{ path: 'subpage3',
                                        component: i28.Control3Control }, { path: 'subpage4', component: i29.Control4Control }] }] }]];
            ...
            [2, i20.RouteReuseStrategy]]), i0.ɵmpd(512, i20.RouterModule, i20.RouterModule, [[2, i20.ɵa], [2, i20.Router]]), i0.ɵmpd(512, i30.ControlsModule, i30.ControlsModule, []), i0.ɵmpd(512, i31.PagesModule, i31.PagesModule, []),
        i0.ɵmpd(512, i32.RoutingModule, i32.RoutingModule, []), i0.ɵmpd(512, i33.AppModule, i33.AppModule, []), i0.ɵmpd(512, i1.ServerAppModule, i1.ServerAppModule, []), i0.ɵmpd(256, i17.ɵe, 'XSRF-TOKEN', []),
